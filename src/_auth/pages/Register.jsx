  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="flex flex-col items-center justify-center w-72 bg-black rounded-xl p-5 text-white gap-4">
        <h1 className="text-2xl font-bold border-b-yellow-400 border-b-2 w-full text-center pb-1">
          Register
        </h1>
        <form
        ...
        >
          ...
          <button
            type="submit"
            className="bg-yellow-700 rounded-xl mt-3 px-8 p-1 font-bold text-xl"
          >
            Sign up
          </button>
        </form>
        <button
          className="bg-yellow-700 rounded-xl px-4 p-1 border-black font-bold text-xl"
